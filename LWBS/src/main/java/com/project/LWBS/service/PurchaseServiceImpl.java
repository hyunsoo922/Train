...
public class PurchaseServiceImpl implements PurchaseService{
    ...
    public Purchase paymentKakaoPay(String item,String totalPrice,String totalCnt) {
        ...
        // 13.53.240.181:8093
        String requestJson = "{\"cid\":\"TC0ONETIME\",\"partner_order_id\":\"Kakao20230829\",\"partner_user_id\":\"KakaoPay\",\"item_name\":\"" + item + "\",\"quantity\":\"" + totalCnt + "\",\"total_amount\":\"" + totalPrice + "\",\"tax_free_amount\":\"0\",\"approval_url\":\"http://13.53.240.181:8093/purchase/success\",\"cancel_url\":\"http://13.53.240.181:8093/purchase/cancel\",\"fail_url\":\"http://13.53.240.181:8093/purchase/fail\"}";
