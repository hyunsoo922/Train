...
public class PurchaseServiceImpl implements PurchaseService{
    ...
    public Purchase paymentKakaoPay(String item,String totalPrice,String totalCnt) {
        ...
        paymentData.add("approval_url","http://localhost:8093/student/kakaoPay/success");
        paymentData.add("cancel_url","http://localhost:8093/student/kakaoPay/cancel");
        paymentData.add("fail_url","http://localhost:8093/student/kakaoPay/fail");
